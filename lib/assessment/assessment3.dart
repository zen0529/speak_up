...
class assessment3 extends StatefulWidget {
  const assessment3({super.key});

  @override
  State<assessment3> createState() => _assessment3State();
}

class _assessment3State extends State<assessment3> {
  @override
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Image.asset('assets/images/dashboard/record.png'),
                      const SizedBox(
                        width: 27,
                      ),
                      SizedBox(
                        ...
                        child: Material(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: () {
                              Navigator.pushNamed(context, '/assessment4');
                            },
                            child: Text("Finish",
                                style: GoogleFonts.inter(
                                  color: const Color(0xFF505050),
